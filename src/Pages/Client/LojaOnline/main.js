                    ...
                    <div className="col-md-12 col-lg-7 pt-pageLeft">
                        <div className="row">
                            ...
                            <div className="col-md-12 col-lg-10 offset-lg-1">
                                ...
                                <CheckBox name="Com Integração" color="bg-checkBoxPurple" colorIcon="colorIconPurple" textColor="text-purple" />
                                <CardsCheckBox text="Para a criação da sua página online quais os tópicos que gostaria de adicionar?" />
                    ...
                    <div className="col-md-12 col-lg-5 d-none d-lg-flex justify-content-center align-items-center bg-purple pt-pageRight position-fixed end-0 vh-100">
                        <div className="row">
                            <div className="col-md-auto">
                                <img src={ImagemLojaOnline} className="img-fluid" alt="Loja Online Imagem" />
                            </div>
                        </div>
                    </div>
                </div>
