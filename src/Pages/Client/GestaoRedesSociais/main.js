            ...
            <div className="container-fluid ">
                <div className="row ">
                    ...
                    <div className="col-md-12 offset-lg-1 col-lg-10 font-weight-semiBold font-size-1__5rem pt-pageLeft">
                        Orçamento / Marketing Digital / <span class="font-weight-bold text-yellow">Gestão de redes sociais</span>
                    </div>
                    ...
                    <div className="col-md-12 offset-lg-1 col-lg-2">
                        <div className="mt-5">
                            ...
                            <div className="text-center mb-5 mt-5">
                                <button type="button" className="btn btn-yellow btn-lg rounded-0">Selecionar</button>
                            </div>
                        </div>
                    </div>
